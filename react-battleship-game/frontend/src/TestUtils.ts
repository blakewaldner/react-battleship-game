...
import BattleshipAreaController from './classes/BattleshipAreaController';
...
type MockedTownControllerProperties = {
  ...
  battleshipAreas?: BattleshipAreaController[];
};
export function mockTownController({
  ...
  if (battleshipAreas) {
    Object.defineProperty(mockedController, 'battleshipAreas', { value: battleshipAreas });
  }
